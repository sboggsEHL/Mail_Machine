...
/**
 * Component for multiple values criteria
 */
export const MultipleValuesComponent: React.FC<BaseCriteriaProps> = (props) => {
  ...
  return (
    <div className="multiple-values-criteria criteria-component">
      <h4>{props.name}</h4>
      ...
      <div className="values-list">
        ...
        {values.map((value, index) => (
          <div key={index} className="value-tag badge bg-primary me-2 mb-2">
            <span>{value}</span>
            <button 
