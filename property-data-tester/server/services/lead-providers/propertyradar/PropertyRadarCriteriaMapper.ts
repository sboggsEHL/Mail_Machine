import { PropertyRadarCriteriaInput, PropertyRadarCriterion, PropertyRadarRequest } from './types';

/**
 * Maps user-friendly criteria to PropertyRadar API format
 */
export class PropertyRadarCriteriaMapper {
  /**
   ...
   */
  private static getCriteriaType(criteriaName: string): string | undefined {
   ...
   */
  private static addCriterionByType(
    result: PropertyRadarCriterion[],
    key: string,
    value: any,
    criteriaType?: string
  ): void {
